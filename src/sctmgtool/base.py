...
class Tag(Flag):
    ...
    CriticalHit1      = 0b0000110000000000000000000000000000000000000000
    CriticalHit2      = 0b0001010000000000000000000000000000000000000000
    Instant           = 0b0010000000000000000000000000000000000000000000
    _ConcentratedFire = 0b0100000000000000000000000000000000000000000000
    ConcentratedFire1 = 0b1100000000000000000000000000000000000000000000
    # fmt: on
    ...
    def concentrated_fire(self):
        return self._extract(Tag._ConcentratedFire)


# pylint: disable-next=protected-access
Tag.HIDDEN_MEMBERS_MASK = Tag._AntiEvade | Tag._Precision | Tag._LockedIn | Tag._PierceArmoured | Tag._Tough | Tag._CriticalHit | Tag._ConcentratedFire
